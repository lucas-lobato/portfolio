...
const translations = {
    en: {
        ...
        convite_redes_sociais: "Access my networks:"
    },
    es: {
        ...
        convite_redes_sociais: "Accede a mis redes:"
    },
    pt: {
        ...
        convite_redes_sociais: "Acesse minhas redes:"
    }
};
...
document.getElementById('changeLanguage').addEventListener('click', function () {
    ...
    document.getElementById('convite_redes_sociais').textContent = translatedText.convite_redes_sociais;
